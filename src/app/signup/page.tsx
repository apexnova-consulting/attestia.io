...
export default function SignupPage() {
  ...
  if (success) {
    return (
      <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-gradient-to-br from-primary/5 via-transparent to-blue-500/5">
        <motion.div
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-gradient-to-br from-primary/5 via-transparent to-blue-500/5">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Start attesting documents today</p>
        </div>
